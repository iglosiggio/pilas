...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.fuente = QtWidgets.QPushButton(Dialog)
        ...
        self.checkbox_aceleracion = QtWidgets.QCheckBox(Dialog)
        ...
        self.checkbox_autocompletar = QtWidgets.QCheckBox(Dialog)
        ...
        self.checkbox_atajos = QtWidgets.QCheckBox(Dialog)
